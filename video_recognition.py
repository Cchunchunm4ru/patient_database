...
DATASET_DIR = r"C:\Users\zwano\OneDrive\Desktop\patient_database\pictures"
...
running = True
def recognize_faces():
    global running, recognized_name
    while running:
        ...
        for (x, y, w, h) in faces:
            ...
            if confidence < 70:
                ...
                Name.clear()  
                Name.append(recognized_name) 
                name_var.set(recognized_name)  
